    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('STUDENT', 'Credential Holder'), ('INSTITUTION', 'Credential Issuer'), ('EMPLOYER', 'Credential Verifier')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accreditation_proof', models.FileField(blank=True, null=True, upload_to='accreditations/')),
